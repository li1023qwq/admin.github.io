		...
		methods: {
			...
			getDetail(id) {
				...
				db.collection(dbCollectionName).doc(id).field(
					'category_id,goods_sn,name,price,market_price,keywords,offline_time,city_ids,goods_summary,goods_desc,goods_thumb,goods_banner,goods_banner_imgs,remain_count,group_buying,group_buying_discount,month_sell_count,total_sell_count,comment_count,is_real,is_on_sale,is_alone_sale,is_best,is_new,is_hot,is_vip,add_date,last_modify_date,sku_name,seller_note,use_score,use_score_rate,rebate_score_rate,rebate_self_money,rebate_money_rate'
				).get().then((res) => {
