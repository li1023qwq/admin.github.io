	...
	<view class="login-box">
		...
		<view class="uni-container">
			<uni-forms ref="form" validateTrigger="bind" :rules="rules" @submit="submit">
				<uni-forms-item label="登录名" left-icon="person" name="username" labelWidth="35">
					<input ref="usernameInput" class="uni-input-border" type="text" placeholder="账户"
						@blur="binddata('username',$event.detail.value)" />
				</uni-forms-item>

				<uni-forms-item label="密码" left-icon="locked" name="password" labelWidth="35">
				...
				<uni-forms-item label="确定密码" left-icon="locked" name="passwordConfirmation" labelWidth="35"
				...
				<view class="uni-group" style="margin-top: 30px;" v-if="isDevelopment">
