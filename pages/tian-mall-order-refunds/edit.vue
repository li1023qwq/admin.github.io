  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("create_time,update_time,operater_log,id,order_id,type,reason,goods_status,shop_id,describe,imgs,money,platform,state,user_id,goods,shop,result").get().then((res) => {
