	...
	<view class="uni-container">
		<uni-forms ref="form" :value="formData" validateTrigger="bind">
			...
			<view class="uni-button-group">
				<button type="primary" class="uni-button" style="width: 100px;" @click="submit(0)">提交</button>
				<button type="primary" class="uni-button" style="width: 120px;" @click="submit(1)">提交&新增</button>
