...
<script>
  import { validator } from '../../js_sdk/validator/tian-mall-orders.js';
  ...
  "is_delete_localdata": [
    ...
    },
    {
      ...
      "value": 1
        ...
        rules: {
          ...getValidator(["create_time","operater_log","address","body","cancel_apply","cancel_style","cart_count","delivery_hour","delivery_type","freight","goods","is_delete","juli","last_pay_time","platform","remarks","state","discount","total_fee","invoice","score","user_id"])
        }
      }
    },
    onLoad(e) {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field('create_time,update_time,operater_log,address,body,cancel_apply,cancel_style,cart_count,delivery_hour,delivery_type,freight,goods,is_delete,juli,last_pay_time,platform,remarks,state,discount,total_fee,invoice,score,user_id').get().then((res) => {
