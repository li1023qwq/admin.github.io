  ...
  "state_localdata": [
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field('total_fee,rebate,user_id,shop_id,src,title,body,outTradeNo,shop,payment,payInfo,state,id,create_time,update_time').get().then((res) => {
